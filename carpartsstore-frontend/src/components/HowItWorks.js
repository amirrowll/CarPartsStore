...
const steps = [
    ...
    },
    {
        id: 3,
        title: 'تحویل سریع',
        description: 'ارسال به تمام نقاط کشور در کمتر از 24 ساعت',
        icon: Truck,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => {
            ...
            return (<div key={step.id} className="relative">
                ...
                {index < steps.length - 1 && (<div className="hidden lg:block absolute top-12 -right-4 w-8 h-0.5 bg-gradient-to-r from-blue-500 to-transparent z-10"></div>)}
              </div>);
        })}
        </div>
