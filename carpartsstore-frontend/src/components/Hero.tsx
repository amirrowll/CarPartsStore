...
import { Search, ChevronLeft, ChevronRight, Pause, Play, Loader } from 'lucide-react';
          ...
          <div className="max-w-2xl mx-auto">
            <form onSubmit={handleSearch}>
              <div className="relative">
                ...
                <button
                  type="submit"
                  className="absolute inset-y-0 left-0 pl-4 flex items-center text-blue-300 hover:text-white transition-colors"
                >
            ...
            <div className="mt-6 text-center">
              ...
              >
                <span className="text-lg"> دانلود کاتالوگ پین پارت </span>
              </button>
